...
public class EnhancedDiamondCompondItem extends LandoftheLostElements.ModElement {
	@ObjectHolder("land_of_the_lost:enhanced_diamond_compond")
	public static final Item block = null;
	public EnhancedDiamondCompondItem(LandoftheLostElements instance) {
		super(instance, 6);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("enhanced_diamond_compond");
		}
