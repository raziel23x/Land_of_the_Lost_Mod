...
public class EnchancedDiamondItem extends LandoftheLostElements.ModElement {
	@ObjectHolder("land_of_the_lost:enhanced_diamond")
	public static final Item block = null;
	public EnchancedDiamondItem(LandoftheLostElements instance) {
		super(instance, 1);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("enhanced_diamond");
		}
